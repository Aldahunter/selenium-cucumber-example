...
public class SwagLabsUserLoginsStepDefinitions {
	...
	public void the_users_username(String string) {
	...
	public void the_user_requests(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("enters their login details")
	public void enters_their_login_details() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("they successfully login")
	public void they_successfully_login() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
